...
public class CreateAccountTest {
    ...
    public void testEmptyFirstName(){
        final String expectedErrorMessage = "Enter your first name.";
        ...
        Assert.assertEquals(firstNameErrorMessage.getText(), expectedErrorMessage);
    }

    @Test
    public void testEmptyLastName(){
        final String expectedErrorMessage = "Enter your last name.";
        ...
        Assert.assertEquals(lastNameErrorMessage.getText(), expectedErrorMessage);
    }
    ...
    public void testCreateAccountWithoutPhone(){
        final String instructionHeaderMessage = "Check your email";
        final String instructionDescriptionMessage = "You're almost there! We sent an email to alcachofas@comida.com with a link to activate your account. Please check your email and click the activation link.";
        ...
        Assert.assertEquals(instructionHeader.getText(), instructionHeaderMessage);
        Assert.assertEquals(instructionDescription.getText(), instructionDescriptionMessage);
    }
